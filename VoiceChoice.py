...
st.markdown("<h3 style='text-align: center;'>Mit VoiceChoice hast du die Möglichkeit mit verschiedensten Machine Learning Modellen das Geschlecht einer Person auf der Audioaufnahme klassifizieren.</h3>", unsafe_allow_html=True)
